...
public class EntryDTO {
    ...
    /**
     * Attribute stores the string-representation of the tags. This can be generated by calling
     * {@link TagCollection#toCsv()}.
     */
    private String tags;
    ...
    public EntryDTO(Entry entry) throws NullPointerException {
        ...
        TagCollection tags = entry.getTags();
        if (tags != null) {
            this.tags = tags.toCsv();
        }
        else {
            this.tags = "";
        }
    ...
    public Entry getEntry() {
        ...
        entry.setTags(new TagCollection(tags));
        return entry;
    }
    ...
    private void parseCsv(String csv) {
        ...
        for (int i = 0; i < columns.size(); i++) {
            assignColumnContentToEntry(columns.get(i), i);
        }
    }
     ...
     *                                  the passed content.
     */
    private void assignColumnContentToEntry(String columnContent, int column) throws IllegalArgumentException {
        switch (column) {
            case 0:
                uuid = columnContent;
                break;
