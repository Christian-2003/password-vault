...
/**
 * Class implements a settings item that can store a boolean value.
 *
 * @author  Christian-2003
 * @version 3.6.0
 */
public class BooleanItem extends GenericItem<Boolean> {
     ...
     */
    public BooleanItem(@NonNull ConfigSettingContract config, @NonNull String key, @NonNull Boolean defValue) {
     ...
     */
    public Boolean get() {
        return config.getPreferences().getBoolean(key, defValue);
    }
    ...
    public void set(Boolean value) {
        config.getEditor().putBoolean(key, value).apply();
    }
