...
/**
 * Class implements a settings item that can store an integer value.
 *
 * @author  Christian-2003
 * @version 3.6.0
 */
public class IntItem extends GenericItem<Integer> {
     ...
     */
    public IntItem(@NonNull ConfigSettingContract config, @NonNull String key, @NonNull Integer defValue) {
     ...
     */
    public Integer get() {
        return config.getPreferences().getInt(key, defValue);
    }
    ...
    public void set(Integer value) {
        config.getEditor().putInt(key, value).apply();
    }
