...
public class DetailDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        if (detail.getType() != DetailType.UNDEFINED) {
            ((AutoCompleteTextView)view.findViewById(R.id.detail_dialog_type)).setText(Detail.getTypes()[detail.getType().ordinal()]);
        }
        ((AutoCompleteTextView)view.findViewById(R.id.detail_dialog_type)).setAdapter(new ArrayAdapter<String>(getContext(), android.R.layout.simple_spinner_dropdown_item, Detail.getTypes()));
    ...
    private boolean processUserInput(View view) {
        ...
        DetailType type = Detail.getTypeByName(((AutoCompleteTextView)view.findViewById(R.id.detail_dialog_type)).getText().toString());
