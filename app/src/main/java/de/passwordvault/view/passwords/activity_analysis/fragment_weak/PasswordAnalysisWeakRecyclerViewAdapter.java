...
/**
 * Class implements the recycler view adapter for the {@link PasswordAnalysisWeakFragment}.
 *
...
public class PasswordAnalysisWeakRecyclerViewAdapter extends RecyclerViewAdapter<PasswordAnalysisViewModel> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        switch (position) {
            case 0: {
                ...
                if (viewModel.getWeakPasswords().isEmpty()) {
            ...
            default: {
                PasswordAnalysisDuplicatesRecyclerViewAdapter.PasswordViewHolder viewHolder = (PasswordAnalysisDuplicatesRecyclerViewAdapter.PasswordViewHolder)holder;
                Password password = viewModel.getWeakPasswords().get(position - OFFSET_PASSWORDS);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            default:
                ...
                return new PasswordAnalysisDuplicatesRecyclerViewAdapter.PasswordViewHolder(view);
        }
    }
    ...
    public int getItemCount() {
        return viewModel.getWeakPasswords().size() + 1;
    }
