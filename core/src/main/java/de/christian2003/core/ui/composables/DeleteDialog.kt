...
fun DeleteDialog(
    ...
    onCancel: () -> Unit,
    onConfirm: () -> Unit,
    title: String = stringResource(R.string.deleteDialog_title)
) {
    ...
    BottomSheetDialog(
        ...
        Column(
            modifier = Modifier
                .fillMaxWidth()
                .padding(horizontal = dimensionResource(R.dimen.padding_horizontal_activity))
        ) {
            Text(
                text = message,
            ...
            FlowRow(
                ...
                modifier = Modifier
                    .align(Alignment.End)
                    .padding(bottom = dimensionResource(R.dimen.padding_vertical_activity))
            ) {
                TextButton(
                    onClick = {
                        scope.launch {
                    ...
                    Text(text = stringResource(R.string.deleteDialog_button_cancel))
                }
                TextButton(
                    ...
                    Text(text = stringResource(R.string.deleteDialog_button_confirm))
                }
            }
        }
    }
