 ...
 */
@Composable
fun BottomSheetDialogHeaderWithIcon(
    title: String,
    icon: Painter,
    ...
    Row(
        ...
        modifier = modifier
            .padding(
                horizontal = dimensionResource(R.dimen.padding_horizontal_activity),
                vertical = dimensionResource(R.dimen.padding_vertical_activity)
            )
    ) {
        Icon(
            painter = icon,
        ...
        Text(
            ...
            modifier = Modifier.padding(start = dimensionResource(R.dimen.padding_horizontal_activity))
        )
    }
}
 ...
 */
@Composable
fun BottomSheetDialogHeaderWithComposable(
    title: String,
