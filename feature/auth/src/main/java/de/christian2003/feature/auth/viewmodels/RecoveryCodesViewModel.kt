...
import de.christian2003.feature.auth.models.formatters.RecoveryCodesFormatter
import de.christian2003.feature.auth.models.dialogs.RecoveryCodesScreenDialog
...
internal class RecoveryCodesViewModel @Inject constructor(
     ...
     */
    val state: RecoveryCodesScreenState = savedStateHandle.toRoute<de.christian2003.feature.auth.navigation.RecoveryCodesDestination>().state
